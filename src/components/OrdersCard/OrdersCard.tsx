      ...
      <div className='hidden md:flex md:w-full md:justify-between md:flex-col'>
        <div className='md:flex md:w-full md:justify-between items-start'>
          <div className='flex  flex-col gap-4 items-center'>
            ...
            <div className='flex gap-2 items-start w-full'>
              <div className='uppercase min-w-[140px] text-sm'>Date</div>
              <div className='font-semibold'>{format(parseISO(order.created_at), 'dd.MM.yyyy')}</div>
            </div>
            <div className='flex gap-2 items-start w-full'>
              <div className='uppercase min-w-[140px] text-sm'>Total Quantity</div>
              <div className='font-semibold '>{order.items.length}</div>
            </div>
            <div className='flex gap-2 items-start w-full'>
              <div className='uppercase min-w-[140px] text-sm '>Subtotal</div>
              <div className='font-semibold '>${order.subtotal.toFixed(2)}</div>
            </div>
            <div className='flex gap-2 items-start w-full'>
              <div className='uppercase min-w-[140px] text-sm'>Status</div>
              <div className='font-semibold capitalize'>{order.status}</div>
            </div>
          </div>
