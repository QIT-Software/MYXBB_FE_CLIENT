...
const RegistrationForm = () => {
  ...
  const [signup, { isLoading: loginLoading, isSuccess }] = useSignupMutation()
    ...
    <div className='flex flex-col gap-4'>
      {isSuccess ? (
        <div className='bg-secondary-white p-4 rounded-md'>
          <p>A confirmation email has been sent to your email address. Please verify to complete registration.</p>
          <div className='mt-4'>
            <button className='text-primary-blue underline' onClick={() => router.push('/auth')}>
              Sign in
            </button>
          </div>
        </div>
