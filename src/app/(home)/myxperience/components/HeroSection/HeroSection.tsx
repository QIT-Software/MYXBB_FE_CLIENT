...
const HeroSection = () => {
  ...
  return (
    <>
      ...
      >
        <div className='md:hidden sm:hidden absolute top-[70px] right-[70px] flex justify-center items-center py-5'>
        ...
        <div className='hidden md:flex sm:flex absolute z-50 top-[20px] right-[20px] flex justify-center items-center py-5 gap-[20px]'>
          <Link
            href='/profile'
            className={`ml-6 size-8 overflow-hidden flex items-center
                   justify-center bg-white/40 rounded-full cursor-pointer ${!profile?.avatar && 'opacity-25'}`}
          ...
          <div>
            <MyxIcon name='menu' className='w-[32px] h-[32px] flex items-center justify-center text-white' />
          </div>
        </div>
        <motion.div
          ref={ref}
        ...
        >
          <div className='flex flex-col gap-[17px] items-center'>
            <h1 className='text-4xl text-white suave-text text-[60px] leading-[90px] md:text-[55px] sm:text-[28px]'>
              MYXPERIENCE
            </h1>
